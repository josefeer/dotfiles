return {
  ...
  keys = {
    { "<leader>sf", function() Snacks.picker.files({ignored = true, hidden = true}) end, desc = "[F]iles" },
    { "<leader>s,", function() Snacks.picker.files({ cwd = vim.fn.stdpath("data") .. "/scratch" }) end, desc = "Scratches [,]" },
